...
export default function Footer() {
  return (
    <FooterStyles>
      <div>
        <p>Webseite von Alex Kräuchi | <a href="https://github.com/al-soup/4x30" target="_blank" rel="noopener noreferrer"><wbr/>source code &nbsp;<GithubIcon className="github" /></a></p>
